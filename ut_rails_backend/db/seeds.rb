...
post_1 = Post.create(title: "The Secret to Eating for Muscle? It's Not Your Post-Workout Protein Shake.",
...
",
  ...
  video: 'https://www.youtube.com/embed/42PTdcxTfpc',
  tags: "Health & Fitness",
  user_id: paul.id)

post_2 = Post.create(title: "The Best Shampoos, Conditioners, and Stylers for Men with Long Hair",
    ...
    video: 'https://www.youtube.com/embed/FzXee9UKd7I',
    link: "https://www.gq.com/story/best-products-for-men-with-long-hair",
    tags: "Grooming",
    user_id: mike.id)

post_3 = Post.create(title: "Business cards are for dummies, you dummy",
...
video: 'https://www.youtube.com/embed/cISYzA36-ZY',
link: "https://www.gq-magazine.co.uk/article/forget-business-cards-you-need-calling-cards", tags: "Lifestyle",
user_id: bill.id)


post_4 = Post.create(title: "6 ways to get better at everything right now",
  ...
  video: 'https://www.youtube.com/embed/-MxxzK0oZY8',
...
Like.create([{user_id: bill.id, post_id: post_1.id},
  ...
  {user_id: stephon.id, post_id: post_3.id},
  {user_id: mike.id, post_id: post_2.id}])
