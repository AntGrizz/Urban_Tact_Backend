...
Post.create([{title: "OFF-WHITE's His & Her Collection", 
...
Check out our selection of backstage shots in the gallery above, and be sure to let us know in the comment section following what you are feeling." ,
  ...
  {title: "D.S. & Durga’s Ultra-Luxe New Fragrance Contains Rare Ingredients From India", 
  content: "Cult perfumer D.S. & Durga has launched a new eau de parfum fragrance called D.S., which the brands says is a “pure vision of India.”
...
The fragrance is the second release in D.S. & Durga’s Gold Label line, following the launch of Durga last year. It can be purchased now over at the brand’s webstore.",
  ...
  {title: "The Secret to Eating for Muscle? It's Not Your Post-Workout Protein Shake.", 
...
",
  description: "Stop the post-workout protein shake obsession and focus on protein all day instead.", image: "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/gettyimages-523265143-1551714877.jpg?crop=0.633xw:1.00xh;0.256xw,0&resize=4320:*", 
  ...
  { title: "The Best Shampoos, Conditioners, and Stylers for Men with Long Hair", 
    ...
    image: "https://media.gq.com/photos/5c78431ae718486b18bad771/16:9/w_1280%2Cc_limit/GQ-BestStuff-GroomingCreams-0227-3x2.png", 
    video: "", 
...
{ title: "6 ways to get better at everything right now", 
